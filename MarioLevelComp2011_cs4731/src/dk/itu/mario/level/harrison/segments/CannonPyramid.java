...
public class CannonPyramid extends Segment{
   ...
   @Override public int attach(int start, Level level){
      ...
      level.setBlock(start + 4, y - 3, HarrisonLevel.CANNON);
      level.setBlock(start + 5, y, HarrisonLevel.ROCK);
      level.setBlock(start + 5, y - 1, HarrisonLevel.ROCK);
      level.setBlock(start + 5, y - 2, HarrisonLevel.CANNON);
      level.setBlock(start + 6, y, HarrisonLevel.ROCK);
      level.setBlock(start + 6, y - 1, HarrisonLevel.CANNON);
      level.setBlock(start + 7, y, HarrisonLevel.CANNON);
